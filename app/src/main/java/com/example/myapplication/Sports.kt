...
class Sports : AppCompatActivity(), NewsItemclicked {
    ...
    private fun fetchdata(page:Int) {
        isLoading = true
        url ="https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=ef78e990b17546c98dec95130aa71ba4&page=$page"
